    ...
    partial class AssetStudioGUIForm : Form
    {
        ...
        private void PreviewTexture2D(AssetItem assetItem, Texture2D m_Texture2D)
        {
            ...
            if (bitmap != null)
            {
                ...
                switch (m_Texture2D.m_IsReadable)
                {
                    case true: assetItem.InfoText += "\nRead/Write: True"; break;
                    case false: assetItem.InfoText += "\nRead/Write: false"; break;
                }
                if (m_Texture2D.m_StreamData != null)
                {
                    assetItem.InfoText += "\nMemory Size: " + string.Format("{0:0,0}b", m_Texture2D.m_StreamData.size);
                }
        ...
        private void PreviewMesh(AssetItem assetItem, Mesh m_Mesh)
        {
            ...
            {
                assetItem.InfoText = "submeshCount:" +m_Mesh.m_SubMeshes.Length;
                assetItem.InfoText += "\nVerticesCount: " + m_Mesh.m_VertexCount;
                assetItem.InfoText += "\nTriCount: " + m_Mesh.m_Indices.Count/ 3;
                if (m_Mesh.m_IsReadable == true)
                {
                    assetItem.InfoText += "\nRead/Write: True";
                }
                else 
                ...
                switch (m_Mesh.m_MeshCompression)
                {
                    case 0: assetItem.InfoText += "\nMesh Compression mode: off"; break;
                    case 1: assetItem.InfoText += "\nMesh Compression mode: Low"; break;
                    case 2: assetItem.InfoText += "\nMesh Compression mode: Medium"; break;
                    case 3: assetItem.InfoText += "\nMesh Compression mode: High"; break;
                }
